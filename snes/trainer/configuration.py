...
class Configuration:
    ...
    success_fitness = 300  # If an organism achieves this fitness the training end and the organism id returned, this has to be adapted to fit the game score.

    number_organisms_per_specie = 40
    number_of_species = 20

    number_of_mutations_per_iteration = [1, 2, 4, 8, 16]
    probability_for_mutation_type = [0.05, 0.4, 0.50, 0.05]  # [NewNeuron, NewAxon, IncreasedAxonInfluence, ChangeAxonActivity]
